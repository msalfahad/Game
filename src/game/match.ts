...
export class Match {
  ...
  start(opts: StartOpts) {
    ...
    else this.engine.camera.frame(isClimb ? 17 : halfSize, isGoal ? (portrait ? 1.62 : 1.28) : isIce ? 1.18 : game.mechanic === 'hotpotato' ? 1.7 : game.mechanic === 'kart' ? (portrait ? 1.24 : 1.05) : 1.0);
